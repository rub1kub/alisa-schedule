...
После публикации запуск: **«Алиса, запусти навык Расписание Кэпика»**. 17 сентября карточка повторно отправлена на модерацию после исправления названия и расшифровки аббревиатуры. О настройке своей фразы — в [LAUNCH.md](docs/LAUNCH.md).
