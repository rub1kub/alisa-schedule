...
Публичная карточка **«Расписание Кэпика»** отклонена повторно: название и активационные имена ещё требуют согласования с Яндексом. Замечание к одинаковым ответам «помощь» и «что ты умеешь» исправлено. До одобрения и публикации для проверки используйте приватный навык. Инструкции — в [LAUNCH.md](docs/LAUNCH.md).
