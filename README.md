...
Публичная карточка **«Кэпик»** отправлена на модерацию с подтверждённым сайтом проекта: [лендинг](https://kkepik.rub1kub.ru/about). До одобрения и публикации для проверки используйте приватный навык. Инструкции — в [LAUNCH.md](docs/LAUNCH.md).
