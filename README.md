...
Публичная карточка **«Кэпик»** отклонена модерацией 18 сентября: проверяющий сообщил, что сайт не загружается. Страница проекта: [лендинг](https://kkepik.rub1kub.ru/about). До одобрения и публикации для проверки используйте приватный навык. Инструкции — в [LAUNCH.md](docs/LAUNCH.md).
